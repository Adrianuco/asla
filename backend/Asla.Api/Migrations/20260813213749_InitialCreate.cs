        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                    UbicacionId = table.Column<int>(type: "int", nullable: false),
                    NombreEmprendimiento = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EstadoVerificacion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Productoras_Ubicaciones_UbicacionId",
                        column: x => x.UbicacionId,
                        principalTable: "Ubicaciones",
                        principalColumn: "UbicacionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Productoras_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "UsuarioId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pedidos_Productoras_ProductoraId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermiteTrueque = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Productos_Productoras_ProductoraId",
                        column: x => x.ProductoraId,
                        principalTable: "Productoras",
                        principalColumn: "ProductoraId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trueques_Productoras_ProductoraId",
                        column: x => x.ProductoraId,
                        principalTable: "Productoras",
                        principalColumn: "ProductoraId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trueques_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "UsuarioId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "DetallesTrueque",
                columns: table => new
                {
                    DetalleTruequeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TruequeId = table.Column<int>(type: "int", nullable: false),
                    ProductoId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesTrueque", x => x.DetalleTruequeId);
                    table.ForeignKey(
                        name: "FK_DetallesTrueque_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "ProductoId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetallesTrueque_Trueques_TruequeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesTrueque_ProductoId",
                table: "DetallesTrueque",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesTrueque_TruequeId",
                table: "DetallesTrueque",
                column: "TruequeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productoras_UbicacionId",
                table: "Productoras",
                column: "UbicacionId");

            migrationBuilder.CreateIndex(
                name: "IX_Productoras_UsuarioId",
                table: "Productoras",
                column: "UsuarioId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productos_ProductoraId",
                table: "Productos",
                column: "ProductoraId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trueques_ProductoraId",
                table: "Trueques",
                column: "ProductoraId");

            migrationBuilder.CreateIndex(
                name: "IX_Trueques_UsuarioId",
                table: "Trueques",
                column: "UsuarioId");
